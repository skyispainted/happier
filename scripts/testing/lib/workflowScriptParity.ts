...
const CANONICAL_LANE_PARITY: readonly ParityDefinition[] = Object.freeze([
  {
    ...
    workflowCommands: [
      'yarn workspace @ks-happier/protocol test',
      'yarn workspace @ks-happier/transfers test',
      'yarn workspace @ks-happier/agents test',
      'yarn workspace @ks-happier/cli-common test',
      'yarn workspace @ks-happier/connection-supervisor test',
      'yarn workspace @ks-happier/bootstrap test',
      'yarn workspace @ks-happier/app test:unit',
      'yarn workspace @ks-happier/cli test:unit',
  ...
  },
  {
    ...
    workflowCommands: [
      'yarn workspace @ks-happier/app test:integration',
      'yarn workspace @ks-happier/cli test:integration',
  ...
  },
  {
    ...
    workflowCommands: ['yarn workspace @ks-happier/tests providers:run'],
    workflowMode: 'any',
    triggerMode: 'optional',
  },
  {
