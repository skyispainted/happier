...
import { SPAWN_SESSION_ERROR_CODES, type BackendTargetRefV1, type WindowsRemoteSessionLaunchMode } from '@ks-happier/protocol';
...
import type { SessionMcpSelectionV1 } from '@ks-happier/protocol';
